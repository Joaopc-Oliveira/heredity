...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # If person has no parents in the dataset, use unconditional probabilities
        if people[person]["mother"] is None and people[person]["father"] is None:
            ...
            # Calculate probability of inheriting the gene
            ...
            from_mother = pass_gene_prob(mother_genes)
            from_father = pass_gene_prob(father_genes)
